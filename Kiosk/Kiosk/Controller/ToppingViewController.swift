...
class ToppingViewController: CommonViewController {
    ...
    override func setupView() {
        ...
        NSLayoutConstraint.activate([
            cheeseLabel.topAnchor.constraint(equalTo: customNavigationBar.bottomAnchor, constant: 34),
            cheeseLabel.leadingAnchor.constraint(equalTo: safeArea.leadingAnchor, constant: 40),
            cheeseLabel.trailingAnchor.constraint(equalTo: safeArea.trailingAnchor, constant: -40),
            
            cheeseCollectionView.topAnchor.constraint(equalTo: customNavigationBar.bottomAnchor, constant: 25),
